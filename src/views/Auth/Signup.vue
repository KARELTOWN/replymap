            ...
            <div>
                ...
                <div class="space-y-5">
                  <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <input v-model="firstname" type="text" id="fname" name="fname" placeholder="Entrez votre prénom"
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <input v-model="lastname" type="text" id="lname" name="lname" placeholder="Entrez votre nom"
                        class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                  ...
                  <div>
                    ...
                    <p v-if="errors.confirm_password" style="color: red">{{ errors.confirm_password }}</p>
              ...
              <div class="mt-5">
                <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                  ...
                  <router-link to="/signin" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Se
          ...
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              ...
              <p class="text-center text-gray-400 dark:text-white/60">
                ...
                <strong>REPLAYMAP</strong> vous montre le véritable comportement des utilisateurs sur votre site.
              </p>
            </div>
          </div>
        </div>
...
const { validateRegister } = authValidator()
const router = useRouter()
const schemaRegister = validateRegister()
const firstname = ref('')
const lastname = ref('')
const email = ref('')
const password = ref('')
