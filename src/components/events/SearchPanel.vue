    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-12 lg:gap-4">
        ...
        <div class="sm:col-span-2 lg:col-span-2">
            <button type="button" @click="filter"
                class="h-11 w-full rounded-lg bg-brand-500 px-4 text-sm font-medium text-white transition shadow-theme-xs hover:bg-brand-600 lg:w-auto lg:px-5">
                Filtrer
            </button>
        </div>
    </div>
