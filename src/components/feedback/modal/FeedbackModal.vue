      ...
      >
        ...
        >
          <div class="min-w-0 flex-1">
            <h2
              class="truncate text-base font-semibold text-gray-800 dark:text-white/90 sm:text-lg"
            ...
            <div
              class="mt-1.5 flex flex-wrap items-center gap-x-3 gap-y-1.5 text-xs text-gray-500 dark:text-gray-400"
            >
              <span
                v-if="feedbackSelect_data?.type?.libelle"
              ...
              <span
                v-if="feedbackSelect_data?.status?.libelle"
              ...
              <button
                v-if="feedbackSelect_data?.session_id"
                type="button"
        ...
        <div class="flex min-h-0 flex-1 flex-col lg:flex-row">
          ...
          >
            <p
              v-if="!feedbackSelect_data?.file?.key"
            ...
            >
              <img
                :src="feedbackSelect_data.file.key"
            ...
            <video
              ...
              :src="feedbackSelect_data.file.key"
              controls
              class="max-h-full w-full rounded-lg shadow-sm ring-1 ring-black/5"
            ></video>

            <FileFrame
              v-if="feedbackSelect_data?.file?.key"
              :file="feedbackSelect_data.file"
              :open="showCapture"
